...
describe('Roller', () => {
  describe('constructor', () => {
    test('should default to a six-sided die if no valid faces are provided', () => {
      const roller = new Roller(0);
      expect(roller['_faces']).toEqual(6);
    });

    test('should set the number of faces to the provided value if it is valid', () => {
  ...
  describe('roll', () => {
    test('should return 0 if the value provided is not valid for the number of faces', () => {
      const roller = new Roller(4);
      expect(roller.roll(5)).toEqual(0);
    });

    test('should return the value provided if it is valid for the number of faces', () => {
      const roller = new Roller(4);
      expect(roller.roll(3)).toEqual(3);
    });

    test('should store the value of the roll as the last roll', () => {
      const roller = new Roller(4);
      roller.roll(3);
      expect(roller.last()).toEqual(3);
    });

    test('should update the distribution for the value rolled', () => {
      const roller = new Roller(4);
      roller.roll(3);
  ...
  describe('last', () => {
    ...
    test('should return the value of the latest die roll', () => {
      const roller = new Roller(4);
      roller.roll(3);
      expect(roller.last()).toEqual(3);
    });
  ...
  describe('distribution', () => {
    test('should return a Map with keys for all possible faces and values of 0', () => {
      const roller = new Roller(4);
    ...
    test('should return a Map with updated values for each face that has been rolled', () => {
      const roller = new Roller(4);
      roller.roll(3);
      roller.roll(1);
      roller.roll(2);
